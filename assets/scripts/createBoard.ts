...
export class createBoard extends Component {
  ...
  addLaddersToBoard() {
    ...
    let bottomcellPositionWorld = this.node.parent
      .getComponent(UITransform)
      .convertToNodeSpaceAR(bottomcellPositionLocal);
  ...
  ArrowplayerAnimation() {
    ...
    tween(this.player1ArrowImg)
      .repeatForever(
        tween()
          .to(0.5, {
            position: new Vec3(player1CurrPositionX, player1CurrPositionY + 15, 0),
            scale: new Vec3(1.3, 1, 1.3),
          })
          .to(
            0.5,
            { position: new Vec3(player1CurrPositionX, player1CurrPositionY, 0), scale: new Vec3(1, 1, 1) },
            {
              easing: "quadInOut",
              onComplete: () => {},
            }
    ...
    tween(this.player2ArrowImg)
      .repeatForever(
        tween()
          .to(0.5, {
            position: new Vec3(player2CurrPositionX, player2CurrPositionY + 15, 0),
            scale: new Vec3(1.3, 1, 1.3),
          })
          .to(
            0.5,
            { position: new Vec3(player2CurrPositionX, player2CurrPositionY, 0), scale: new Vec3(1, 1, 1) },
            {
              easing: "quadInOut",
              onComplete: () => {},
            }
    ...
    if (currCell > finalCell) {
      ...
      if (this.player1CurrCell == this.player2CurrCell) {
        ...
        tween(playerImg)
          .to(
            0.1,
            { position: new Vec3(playerCurrCellPositionX + 10, playerCurrCellPositionY + 10, 0) },
            {
              easing: "quadInOut",
              onComplete: () => {},
            }
  ...
  playerLadderClimbAnimation(playerImg: Node, playerCell: number, playerindex: number) {
    ...
    let laddeTopCellWorldPosition = this.node.parent
      .getComponent(UITransform)
    ...
    tween(playerImg)
      .to(
        3,
        { position: laddeTopCellWorldPosition },
        {
          easing: "quadInOut",
          onComplete: () => {
            console.log(" Player ladder move animation ");
  ...
  playerSnakeBiteAnimation(playerImg: Node, playerCell: number, playerindex: number) {
    ...
    let snakeBottomCellWorldPosition = this.node.parent
      .getComponent(UITransform)
